...
'use strict';{if(window["C3_Is_Supported"]){const enableWorker=true;window["c3_runtimeInterface"]=new self.RuntimeInterface({useWorker:enableWorker,workerMainUrl:"workermain.js",engineScripts:["scripts/c3runtime.js"],projectScripts:[["scripts/project/main.js"], ["scripts/project/scriptsInEvents.js"]],mainProjectScript:"scripts/project/main.js",scriptFolder:"scripts/",workerDependencyScripts:["lodash.custom.min.js", "tween.js"],exportType:"html5"})}};
...
globalThis.WebSdkWrapper = (function () {
  ...
  */
  ...
  const Wrapper = {
    ...
    gameplayStart() {
      console.log("gameplay started: ", !!sdkContext.gameplayStarted);
