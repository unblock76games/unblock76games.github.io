class SceneStadium extends Phaser.Scene {
    ...
    create() {
      ...
      if(!musicLoaded){
        ...
        if(time == 300){this.textTime = this.add.text(200, 61, '5:00', { fontFamily: 'Arial', fontSize: 18, color: '#ffff00' });}
        if(time == 600){this.textTime = this.add.text(200, 61, '10:00', { fontFamily: 'Arial', fontSize: 18, color: '#ffff00' });}
        if(time == 900){this.textTime = this.add.text(200, 61, '15:00', { fontFamily: 'Arial', fontSize: 18, color: '#ffff00' });}
...
/*
      ...
      */
//end For versions 2020 and 2019...
//For versions 2018 and earlier...
      if(newGame){
...
//End For versions 2018 and earlier
      if(!team1PlaySet){
        this.setTeam1Play();
      }
      if(!team2PlaySet){
