class SceneStadium extends Phaser.Scene {
    ...
    preload() {
      this.load.image('buttonSound1', 'content/buttonSound1.png');
        ...
        this.load.image('crazyGamesSquare','content/crazyGamesSquare.png');
    ...
    create() {
      ...
      if(!musicLoaded){
        ...
        this.gmDropdown = this.add.image(0,136, 'gmDropdown');
        this.gmDropdown.setOrigin(0,0);
        this.gmDropdown.visible = false;
        if (window.location.href.indexOf("crazygames.com") != -1){
          this.crazyGamesSquare = this.add.image(5,240, 'crazyGamesSquare');
          this.crazyGamesSquare.setOrigin(0,0);
          }
        //if(document.location.host == "www.crazygames.com" || document.location.host == "developer.crazygames.com"){
        //this.crazyGamesSquare = this.add.image(5,240, 'crazyGamesSquare');
       // this.crazyGamesSquare.setOrigin(0,0);
       // }
       ...
       if(mobile){
        ...
        this.textYardline = this.add.text(10, 60, "Ball on the " + yardline, { fontFamily: 'Arial', fontSize: 15, color: '#000000' });
        ...
        if(time == 300){this.textTime = this.add.text(200, 60, '5:00', { fontFamily: 'Arial', fontSize: 18, color: '#000000' });}
        if(time == 600){this.textTime = this.add.text(200, 60, '10:00', { fontFamily: 'Arial', fontSize: 18, color: '#000000' });}
        if(time == 900){this.textTime = this.add.text(200, 60, '15:00', { fontFamily: 'Arial', fontSize: 18, color: '#000000' });}
        ...
        this.speedBarMask = this.add.sprite(825,475,'speedBarMask');
        this.speedBarMask.setOrigin(0.5,1.0);
        this.speedBar = this.add.sprite(825,450,'speedBar');
        this.speedBar.setOrigin(0.5,1.0);
