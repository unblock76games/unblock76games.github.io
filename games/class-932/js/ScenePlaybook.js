    ...
    this.graphics2.lineBetween(200, this.gradientLineX, 800, 0);
        ...
        this.btnReturnMiddle = this.add.sprite(440,150,"button1");
         ...
         // this.btnDeepKick.setOrigin(0,0);
          this.btnDeepKick = this.add.sprite(533,150,"button1");
...
//CONTAINERS...
          ...
          this.kickOffPlaybook.add([this.bgKickOffPlaybook, this.btnDeepKick, this.btnKickOffKick]);
          ...
          this.offensivePlaybook.add([this.bgOffensePlaysI,this.bgOffensePlaysSplit,this.bgOffensePlaysShotgun,this.bgOffensePlaysBunch,this.bgOffensePlaysAce,this.bgOffensePlaysEmpty,this.bgOffenseFormations]);
          this.offensivePlaybook.add([this.btnSplit,this.btnIFormation, this.btnShotgun, this.btnBunch, this.btnAce, this.btnEmpty,this.buttonBack]);
          this.offensivePlaybook.visible = false;
