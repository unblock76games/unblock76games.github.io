function CMsgBox(szMsg, oFunction) {
    ...
    this._init = function (szMsg, oFunction) {
        ...
        _oTitleStroke = new createjs.Text(szMsg," 26px "+PRIMARY_FONT, "#000000");
        ...
        _oTitle = new createjs.Text(szMsg," 26px "+PRIMARY_FONT, "#ffffff");
        ...
        _oButYes = new CGfxButton(0, 80, s_oSpriteLibrary.getSprite('but_yes_big'), _oPanelContainer);
