function CLevelBut(iXPos,iYPos,oSprite, bActive, iLevel, oParentContainer){
	...
	_oBg = createSprite(oSpriteSheet, "on",iWidth/2,iHeight/2,iWidth,iHeight); 
        ...
        this.addInfo(STAGE_METER_LENGTH[iLevel-1] + TEXT_M);
    ...
    this.addInfo = function(iInfo){
        _oInfoStroke = new createjs.Text(iInfo," 24px "+PRIMARY_FONT, "#3e240b");
    ...
    this.addScore = function(iScore){
        var oScoreStroke = new createjs.Text(formatTime(iScore)," 20px "+PRIMARY_FONT, "#3e240b");
        ...
        var oScore = new createjs.Text(formatTime(iScore)," 20px "+PRIMARY_FONT, "#ffffff");
    ...
    this.addLevelText = function(iLevel){
        _oLevelStroke = new createjs.Text(iLevel," 60px "+PRIMARY_FONT, "#3e240b");
        _oLevelStroke.y = 5;
        ...
        _oLevel = new createjs.Text(iLevel," 60px "+PRIMARY_FONT, "#ffd800");
        _oLevel.y = 5;
