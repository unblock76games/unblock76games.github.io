...
function removeItem(szItem){
    if(s_bStorageAvailable){
        localStorage.removeItem(szItem);
    } 
}
...
function fullscreenHandler(){
    ...
    if(s_oModeSelect !== null){
        s_oModeSelect.resetFullscreenBut();
    }
    ...
    if(s_oSelectTeam !== null){
        s_oSelectTeam.resetFullscreenBut();
    }
}
