class SceneDifficultyMenu extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('menuDifficulty', 'content/scoreboardMask.png');
...
this.player2.setScale(0.9);
      ...
      this.graphics.lineBetween(200, this.gradientLineX, 800, 0);
        ...
        this.textDifficulty = this.add.text(533, 200, "DIFFICULTY", { fontFamily: 'Arial', fontSize: 48, color: '#ffffff' });
        this.textDifficulty.setOrigin(0.5, 0.5);
        this.textDifficulty.setStroke('#000000', 4);
        this.textDifficulty.setShadow(-4, 4, '#333333', 4, true, true);

        this.textRookie = this.add.text(70, 400, "ROOKIE", { fontFamily: 'Arial', fontSize: 24, color: '#ffffff' });
        this.textRookie.setOrigin(0.0, 0.5);
        this.textRookie.setStroke('#000000', 4);
        this.textRookie.setShadow(-4, 4, '#333333', 4, true, true);

        this.textVeteran = this.add.text(270, 400, "VETERAN", { fontFamily: 'Arial', fontSize: 24, color: '#ffffff' });
        this.textVeteran.setOrigin(0.0, 0.5);
        this.textVeteran.setStroke('#000000', 4);
        this.textVeteran.setShadow(-4, 4, '#333333', 4, true, true);

        this.textAllPro = this.add.text(470, 400, "ALL PRO", { fontFamily: 'Arial', fontSize: 24, color: '#ffffff' });
        this.textAllPro.setOrigin(0.0, 0.5);
        this.textAllPro.setStroke('#000000', 4);
        this.textAllPro.setShadow(-4, 4, '#333333', 4, true, true);

        this.textHallOfFame = this.add.text(640, 400, "HALL of FAME", { fontFamily: 'Arial', fontSize: 24, color: '#ffffff' });
        this.textHallOfFame.setOrigin(0.0, 0.5);
        this.textHallOfFame.setStroke('#000000', 4);
        this.textHallOfFame.setShadow(-4, 4, '#333333', 4, true, true);
...
*/
        ...
        this.buttonDifficulty1 = this.add.sprite(30,400,"buttonDifficulty1");
        this.buttonDifficulty1.setOrigin(0,0.5);
          ...
          this.buttonDifficulty2 = this.add.sprite(230,400,"buttonDifficulty1");
        this.buttonDifficulty2.setOrigin(0,0.5);
          ...
          this.buttonDifficulty3 = this.add.sprite(430,400,"buttonDifficulty1");
        this.buttonDifficulty3.setOrigin(0,0.5);
          ...
          this.buttonDifficulty4 = this.add.sprite(630,400,"buttonDifficulty1");
