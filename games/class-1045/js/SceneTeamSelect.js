class SceneTeamSelect extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('menuTeams', 'content/scoreboardMask.png');
    ...
    create() {
      ...
      selectingHome = true;
        ...
        this.textTime = this.add.text(533, 55, "Pick Your HOME Team", { fontFamily: 'Arial', fontSize: 30, color: '#ffffff' });
    ...
    update(){
      ...
      if(sound){
        ...
        this.btnSound.setTexture("buttonSound2");
            ...
            this.graphics.lineGradientStyle(480, 0x000000, 0xffffff, 0x00ffff, 0x0000ff, this.alpha);
            ...
            if(this.gradientLineX > 1000 && this.gradientLineX < 2000){
              ...
              //this.alpha -= 0.001*this.alphaBounce;
              //this.graphics.lineGradientStyle(480, 0x0000ff, 0x0000ff, 0xffffff, 0xffffff, this.alpha);
              //this.graphics.lineBetween(0, 240, -1000+this.gradientLineX, 240);
            }
            if(this.gradientLineX > 1000 && this.gradientLineX < 3000){
              this.alpha -= 0.001*this.alphaBounce;
              this.graphics.lineGradientStyle(480, 0x0000ff, 0x0000ff, 0x000000, 0x000000, this.alpha);
