class ScenePlayoffBracket extends Phaser.Scene {
  ...
  create() {
      ...
      //this.visitorTeam = this.add.image(595,75,'helmetLions');
      ...
      if(playoffConference == "NFC"){
        ...
        this.visitorTeam = this.add.image(790,42,'helmetBears');
      }
      ...
      */
      this.buttonSteelers = this.add.sprite(63, 331, 'helmetSteelers');
      this.buttonSteelers.setScale(-1,1);

      this.buttonBrowns = this.add.sprite(63, 271, 'helmetBrowns');
      this.buttonBrowns.setScale(-1,1);

      //2022...
      /*this.buttonRavens = this.add.sprite(63, 444, 'helmetRavens');
      this.buttonRavens.setScale(-1,1);*/
      this.buttonTexans = this.add.sprite(63, 444, 'helmetTexans');
      this.buttonTexans.setScale(-1,1);
      ...
      if(player1Key == "keyChiefs"){
        this.buttonChiefs = this.add.sprite(63, 100, 'helmetTexans');
        this.buttonChiefs.setScale(-1,1);
      }else{
        this.buttonChiefs = this.add.sprite(63, 100, 'helmetChiefs');
        this.buttonChiefs.setScale(-1,1);
      ...
      this.buttonDolphins = this.add.sprite(63, 215, 'helmetDolphins');
      this.buttonDolphins.setScale(-1,1);

      //2023
      //this.buttonTitans = this.add.sprite(63, 386, 'helmetTitans');
      //this.buttonTitans.setScale(-1,1);
      this.buttonRavens = this.add.sprite(63, 386, 'helmetRavens');
      this.buttonRavens.setScale(-1,1);
      ...
      //NFC
      //this.buttonLions = this.add.sprite(790, 100, 'helmetLions');
      //if player chooses Lions
      if(player1Key == "keyLions"){
        this.buttonLions = this.add.sprite(790, 100, 'helmetCardinals');
      }else{
        this.buttonLions = this.add.sprite(790, 100, 'helmetLions');
      }

      this.buttonCowboys = this.add.sprite(790, 386, 'helmetCowboys');

      this.buttonBuccaneers = this.add.sprite(790, 444, 'helmetBuccaneers');

      this.buttonPackers = this.add.sprite(790, 157, 'helmetPackers');  

      this.buttonEagles = this.add.sprite(790, 271, 'helmetEagles');

      this.buttonNiners = this.add.sprite(790, 331, 'helmetNiners');

      this.buttonRams = this.add.sprite(790, 215, 'helmetRams');
...
//Rounds helmets...
      ...
      if(playoffRound >= 2){
        ...
        this.buttonAFC2d = this.add.sprite(158, 392, 'helmetTexans');
        ...
        if(playoffConference == "NFC"){
          ...
          this.buttonNFC2a = this.add.sprite(695, 92, 'helmetLions');
        } 
        if(player1Key != "keyNiners"){
          this.buttonNFC2b = this.add.sprite(695, 167, 'helmetNiners');
        }else{
          this.buttonNFC2b = this.add.sprite(695, 167, 'helmetEagles');
        }
        this.buttonNFC2c = this.add.sprite(695, 318, 'helmetPackers');
        ...
        if(playoffConference == "AFC"){
          ...
          if(playoffRound == 3){
            ...
            if(player1Key == "keyBills"){
              ...
              this.buttonAFC3b = this.add.sprite(257, 280, 'helmetTexans');
              this.buttonAFC3b.setScale(-1,1);
            }
          }
        }else{
        ...
        if(playoffConference == "NFC"){
          ...
          if(playoffRound == 3){
            ...
            if(player1Key == "keyBuccaneers"){
              ...
              this.buttonNFC3b = this.add.sprite(600, 280, 'helmetPackers');
            }
          }
        }else{
          this.buttonNFC2a = this.add.sprite(600, 205, 'helmetLions');
        } 
      }
      if(playoffRound == 4){
        //afc
        ...
        if(playoffConference == "NFC"){
          ...
          this.buttonNFC2a = this.add.sprite(500, 252, 'helmetNiners');
        } 
...
*/
      ...
      this.btnPlay.setOrigin(0,0);
        ...
        this.btnPlay.on("pointerup", function() {
          ...
          //playerGraphics = ['content/playerLions.png','content/playerRaiders.png'];
      ...
      this.btnSelect2.setOrigin(0,0);
        ...
        this.btnSelect2.on("pointerup", function() {
          ...
          playerGraphics = ['content/playerRaiders.png', 'content/playerLions.png'];
          this.scene.start("SceneTimeMenu");
        }, this);
        */
