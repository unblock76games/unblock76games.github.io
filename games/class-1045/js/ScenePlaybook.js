class ScenePlaybook extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('playbookMask','content/playbookMask.png');
    ...
    create() {
      this.cameras.main.setBounds(100, 0, 4000, 4000);
    ...
    this.graphics2.lineBetween(200, this.gradientLineX, 800, 0);
        ...
        this.playbookMask = this.add.sprite(0,0, 'playbookMask');
        this.playbookMask.setOrigin(0,0);
        this.playbookMask2 = this.add.sprite(0,0, 'playbookMask');
        this.playbookMask2.setOrigin(0,0);
        this.playbookMask3 = this.add.sprite(0,0, 'playbookMask');
        this.playbookMask3.setOrigin(0,0);
        this.playbookMask4 = this.add.sprite(0,0, 'playbookMask');
        this.playbookMask4.setOrigin(0,0);
        this.playbookMask5 = this.add.sprite(0,0, 'playbookMask');
        this.playbookMask5.setOrigin(0,0);
        ...
        //button instructions
        this.buttonInstructions = this.add.sprite(140,175,"buttonInstructions1");
        ...
        this.btnReturnMiddle = this.add.sprite(440,150,"button1");
          ...
          this.btnReturnMiddle.on("pointerup", function() {
            ...
            //start Poki...
            //temp 2022 comment...
            //2023 commented out temporarily...
            gameStart();
            //end Poki
          kickReturnTeam = 1;
          offensiveTeam = 1;
          ...
          //2023 return
          this.btnReturnCross = this.add.sprite(240,280,"button1");
          this.btnReturnCross.setOrigin(0,0);
          this.btnReturnCross.setInteractive();
          this.btnReturnCross.on("pointerover", function() { this.btnReturnCross.setTexture("button2");}, this);
          this.btnReturnCross.on("pointerout", function() {  this.btnReturnCross.setTexture("button1");}, this);
          this.btnReturnCross.on("pointerdown", function() {  this.btnReturnCross.setTexture("button2"); }, this);
          this.btnReturnCross.on("pointerup", function() {
            kickOff = true;
            //start Poki...
            //temp 2022 comment...
              gameStart();
            ...
            openSpecialTeamsPlaybook = false;
            team1Formation = "kickReturn";team2Formation = "kickOff";
            team1Play = "kickReturnCross";team2Play = "kickOffMiddle";
            kickOffStarted = true;
            this.setRoutes();
            down = 0;
          }, this);

          this.btnReturnWedges = this.add.sprite(440,280,"button1");
          this.btnReturnWedges.setOrigin(0,0);
          this.btnReturnWedges.setInteractive();
          this.btnReturnWedges.on("pointerover", function() { this.btnReturnWedges.setTexture("button2");}, this);
          this.btnReturnWedges.on("pointerout", function() {  this.btnReturnWedges.setTexture("button1");}, this);
          this.btnReturnWedges.on("pointerdown", function() {  this.btnReturnWedges.setTexture("button2"); }, this);
          this.btnReturnWedges.on("pointerup", function() {
            kickOff = true;
            //start Poki...
            //temp 2022 comment...
            //2023 commented out temporarily...
          ...
          openSpecialTeamsPlaybook = false;
          team1Formation = "kickReturn";team2Formation = "kickOff";
          team1Play = "kickReturnWedges";team2Play = "kickOffMiddle";
          kickOffStarted = true;
          this.setRoutes();
          down = 0;
          }, this);

          this.btnReturnAttack = this.add.sprite(640,280,"button1");
          this.btnReturnAttack.setOrigin(0,0);
          this.btnReturnAttack.setInteractive();
          this.btnReturnAttack.on("pointerover", function() { this.btnReturnAttack.setTexture("button2");}, this);
          this.btnReturnAttack.on("pointerout", function() {  this.btnReturnAttack.setTexture("button1");}, this);
          this.btnReturnAttack.on("pointerdown", function() {  this.btnReturnAttack.setTexture("button2"); }, this);
          this.btnReturnAttack.on("pointerup", function() {
            kickOff = true;
            //start Poki...
            //2023 commented out temporarily...
             gameStart();
          ...
          openSpecialTeamsPlaybook = false;
          team1Formation = "kickReturn";team2Formation = "kickOff";
          team1Play = "kickReturnAttack";team2Play = "kickOffMiddle";
          kickOffStarted = true;
          this.setRoutes();
          down = 0;
          }, this);
         ...
         // this.btnDeepKick.setOrigin(0,0);
          ...
          //2024
          this.btnStore = this.add.sprite(840,400,"buttonPickField1");
          ...
          //2024
          this.btnStore2 = this.add.sprite(840,400,"buttonPickField1");
          this.btnStore2.setOrigin(0,0);
            this.btnStore2.setInteractive();
            this.btnStore2.on("pointerover", function() {
              this.btnStore2.setTexture("buttonPickField2"); // set the buttonPickField texture to sprbtnInstructionsHover
              //this.sfx.btnOver.play(); // play the buttonPickField over sound
            }, this);
            this.btnStore2.on("pointerout", function() {
              this.setTexture("buttonPickField1");
            });
            this.btnStore2.on("pointerdown", function() {
              this.btnStore2.setTexture("buttonPickField2");
              //this.sfx.btnDown.play();
            }, this);
            this.btnStore2.on("pointerup", function() {
              this.btnStore2.setTexture("buttonPickField1");
              this.PokiStore.visible = true;
              this.sound.play('soundButton');
            }, this);
...
//CONTAINERS...
          ...
          this.specialTeamsPlaybook.add([this.btnReturnCross]);
          this.specialTeamsPlaybook.add([this.btnReturnWedges]);
          this.specialTeamsPlaybook.add([this.btnReturnAttack]);
          this.specialTeamsPlaybook.add([this.btnStore2]);
          this.specialTeamsPlaybook.visible = false;

          //this.kickOffPlaybook.add([this.bgKickOffPlaybook, this.btnOnsideKick, this.btnDeepKick, this.btnKickOffKick]);
          this.kickOffPlaybook.add([this.bgKickOffPlaybook, this.btnDeepKick, this.btnOnsideKick, this.btnKickOffKick,this.btnStore]);
          this.kickOffPlaybook.visible = false;

          this.containerPAT.add([this.playbookMask3,this.bgPAT,this.btn2ptConversion,this.btnExtraPoint,this.btnExtraPointKick,this.trianglePath,this.triangle]);
          this.containerPAT.visible = false;

          this.offensivePlaybook.add([this.playbookMask,this.bgOffensePlaysI,this.bgOffensePlaysSplit,this.bgOffensePlaysShotgun,this.bgOffensePlaysBunch,this.bgOffensePlaysAce,this.bgOffensePlaysEmpty,this.bgOffensePlaysRedZone,this.bgOffensePlaysSpecials, this.bgOffenseFormations]);
          ...
          this.defensivePlaybook.add([this.playbookMask4,this.bgDefense,this.bgDefenseCov]);
          this.defensivePlaybook.add([this.btn43,this.btn34,this.btnBear,this.btn44Stack,this.btn43Over,this.btn62]);
          this.defensivePlaybook.visible = false;

          this.containerMC.add([this.playbookMask2,this.bgTD,this.graphics,this.star,this.shield,this.cheerleader1, this.cheerleader2,this.tdMCTouchdown, this.scoreboardMask]);
          ...
          this.containerConversionGood.add([this.playbookMask5,this.bgTD2,this.graphics2,this.cheerleader3, this.cheerleader4,this.conversionGoodMC, this.scoreboardMask5]);
          ...
          this.PokiStore = this.add.container(100, 0);
    ...
    setRoutes(){
      ...
      if(team1Play == "kickReturnCross"){
        team1RouteLT = [[200,360],[-10,360],[200,-1200]];team1RouteLG = [[150,360],[-10,360],[150,-1200]];team1RouteC = [[-150,300],[10,300],[-150,-600]];team1RouteRG = [[-200,300],[10,300],[-200,-600]];team1RouteRT = [[-250,300],[10,300],[-250,-600]];
        team1RouteWR1 = [[200,360],[250,400],[-10,400],[250,-1200]];team1RouteWR2 = [[50,360],[50,400],[-10,400],[50,-1200]];team1RouteWR3 = [[-300,360],[10,360],[-300,-960]];
        team1RouteFB = [[-100,240],[10,240],[-100,-960]];team1RouteQB = [[50,200],[-10,200],[150,-1200]];
      }
      if(team1Play == "kickReturnWedges"){
        team1RouteLT = [[10,400],[0,-1200]];team1RouteLG = [[-50,400],[-20,-1200]];team1RouteC = [[-130,400],[-120,-1200]];team1RouteRG = [[50,400],[40,-1200]];team1RouteRT = [[-10,400],[0,-1200]];
        team1RouteWR1 = [[0,420],[0,420],[0,-1200]];team1RouteWR2 = [[0,400],[0,400],[0,-1200]];team1RouteWR3 = [[10,350],[10,350],[10,-1200]];
        team1RouteFB = [[0,350],[0,350],[0,-1200]];team1RouteQB = [[-140,200,],[-140,-1200]];
      }
      if(team1Play == "kickReturnAttack"){
        team1RouteLT = [[0,-360],[0,360],[0,-1200]];team1RouteLG = [[0,-360],[0,360],[0,-1200]];team1RouteC = [[0,-360],[0,360],[0,-1200]];team1RouteRG = [[0,-360],[0,360],[0,-1200]];team1RouteRT = [[0,-360],[0,360],[0,-1200]];
        team1RouteWR1 = [[100,-360],[150,400],[150,-1200]];team1RouteWR2 = [[-100,-360],[-150,100],[-150,-1200]];team1RouteWR3 = [[-100,-360],[-50,10],[-50,-1200]];
        team1RouteFB = [[100,-360],[50,0],[50,-1200]];team1RouteQB = [[0,200,],[0,-1200]];
      }
