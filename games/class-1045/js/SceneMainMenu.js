    ...
    */
    ...
    preload() {
      ...
      */
      //end crazygames
        ...
        this.load.image('mainMenuHighlight','content/mainMenuHighlight.png');
    ...
    create() {
      ...
      const isIpad = () => {
        ...
        this.mainMenuHighlight = this.add.image(0,480,'mainMenuHighlight');
        this.mainMenuHighlight.setOrigin(1,1);
        //this.shieldScale = 20;
        ...
        this.btnPlay = this.add.sprite(30,400,"buttonPlay1");
        this.btnPlay.setOrigin(0,0);
          ...
          this.btnPickTeams = this.add.sprite(230,400,"buttonPickTeams1");
        this.btnPickTeams.setOrigin(0,0);
         ...
         this.btnPlayoffSeason = this.add.sprite(430,400,"buttonPlayoffSeason1");
         this.btnPlayoffSeason.setOrigin(0,0);
          ...
          this.btnInstructions = this.add.sprite(630,400,"buttonInstructions1a");
        ...
        //this.instructions.visible = false;
          ...
          this.crowdCheer = this.sound.play('soundCrowdCheer', {volume: 0.25});
    ...
    update(){
      ...
      this.mainMenuHighlight.x += 8;
      if(this.mainMenuHighlight.x > 1500){
        this.mainMenuHighlight.x = Math.random()*-3000;
      }
