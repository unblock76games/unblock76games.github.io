function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        _pStartPosExit = {x: CANVAS_WIDTH/2 +244, y: 254};
        _oButExit = new CGfxButton(_pStartPosExit.x, _pStartPosExit.y, oSprite, _oContainer);
        _oButExit.addEventListener(ON_MOUSE_UP, this.unload, this);
        
        _oMsgText = new createjs.Text(TEXT_CREDITS_DEVELOPED,"36px "+FONT_GAME, "#ffffff");
        ...
        _oLink = new createjs.Text("www.codethislab.com","36px "+FONT_GAME, "#ffffff");
