(function (scope) {
  ...
  !(function (r) {
    ...
    for (var n = CryptoJS, t = (s = n.lib).WordArray, i = s.Hasher, s = n.algo, a = [], f = [], o = 2, d = 0; d < 64; ) {
      ...
      u && (d < 8 && (a[d] = e(r.pow(o, 0.5))), (f[d] = e(r.pow(o, 1 / 3))), d++), o++;
    }
    var m = [];
    s = s.SHA256 = i.extend({
      _doReset: function () {
      ...
      _doProcessBlock: function (e, n) {
        for (var t = this._hash.words, i = t[0], r = t[1], s = t[2], a = t[3], o = t[4], d = t[5], u = t[6], c = t[7], l = 0; l < 64; l++) {
          ...
          (v = c + (((o << 26) | (o >>> 6)) ^ ((o << 21) | (o >>> 11)) ^ ((o << 7) | (o >>> 25))) + ((o & d) ^ (~o & u)) + f[l] + m[l]),
            (g = (((i << 30) | (i >>> 2)) ^ ((i << 19) | (i >>> 13)) ^ ((i << 10) | (i >>> 22))) + ((i & r) ^ (i & s) ^ (r & s))),
            (c = u),
            (u = d),
            (d = o),
            (o = (a + v) | 0),
    ...
    (function () {
      ...
      CryptoJS.enc.Base64 = {
        stringify: function (e) {
          ...
          e.clamp(), (e = []);
          for (var r = 0; r < t; r += 3)
            for (var s = (((n[r >>> 2] >>> (24 - (r % 4) * 8)) & 255) << 16) | (((n[(r + 1) >>> 2] >>> (24 - ((r + 1) % 4) * 8)) & 255) << 8) | ((n[(r + 2) >>> 2] >>> (24 - ((r + 2) % 4) * 8)) & 255), a = 0; a < 4 && r + 0.75 * a < t; a++) e.push(i.charAt((s >>> (6 * (3 - a))) & 63));
    ...
    (function (e) {
      ...
      ((n = e.EGAErrorSeverity || (e.EGAErrorSeverity = {}))[(n.Undefined = 0)] = "Undefined"),
        (n[(n.Debug = 1)] = "Debug"),
        (n[(n.Info = 2)] = "Info"),
        (n[(n.Warning = 3)] = "Warning"),
        (n[(n.Error = 4)] = "Error"),
        (n[(n.Critical = 5)] = "Critical"),
        ((t = e.EGAProgressionStatus || (e.EGAProgressionStatus = {}))[(t.Undefined = 0)] = "Undefined"),
        (t[(t.Start = 1)] = "Start"),
        (t[(t.Complete = 2)] = "Complete"),
        (t[(t.Fail = 3)] = "Fail"),
        ((i = e.EGAResourceFlowType || (e.EGAResourceFlowType = {}))[(i.Undefined = 0)] = "Undefined"),
        (i[(i.Source = 1)] = "Source"),
        (i[(i.Sink = 2)] = "Sink"),
        ((r = e.EGAAdAction || (e.EGAAdAction = {}))[(r.Undefined = 0)] = "Undefined"),
        ...
        ((a = e.EGAAdType || (e.EGAAdType = {}))[(a.Undefined = 0)] = "Undefined"),
        (a[(a.Video = 1)] = "Video"),
        (a[(a.RewardedVideo = 2)] = "RewardedVideo"),
        (a[(a.Playable = 3)] = "Playable"),
        (a[(a.Interstitial = 4)] = "Interstitial"),
        (a[(a.OfferWall = 5)] = "OfferWall"),
        (a[(a.Banner = 6)] = "Banner"),
        (o = e.http || (e.http = {})),
        ((d = o.EGAHTTPApiResponse || (o.EGAHTTPApiResponse = {}))[(d.NoResponse = 0)] = "NoResponse"),
        (d[(d.BadResponse = 1)] = "BadResponse"),
        (d[(d.RequestTimeout = 2)] = "RequestTimeout"),
        (d[(d.JsonEncodeFailed = 3)] = "JsonEncodeFailed"),
        (d[(d.JsonDecodeFailed = 4)] = "JsonDecodeFailed"),
        (d[(d.InternalServerError = 5)] = "InternalServerError"),
        (d[(d.BadRequest = 6)] = "BadRequest"),
        (d[(d.Unauthorized = 7)] = "Unauthorized"),
        (d[(d.UnknownResponseCode = 8)] = "UnknownResponseCode"),
        (d[(d.Ok = 9)] = "Ok"),
        (d[(d.Created = 10)] = "Created"),
        (u = e.events || (e.events = {})),
        ((c = u.EGASdkErrorCategory || (u.EGASdkErrorCategory = {}))[(c.Undefined = 0)] = "Undefined"),
        (c[(c.EventValidation = 1)] = "EventValidation"),
        (c[(c.Database = 2)] = "Database"),
        (c[(c.Init = 3)] = "Init"),
        (c[(c.Http = 4)] = "Http"),
        (c[(c.Json = 5)] = "Json"),
        ((l = u.EGASdkErrorArea || (u.EGASdkErrorArea = {}))[(l.Undefined = 0)] = "Undefined"),
        (l[(l.BusinessEvent = 1)] = "BusinessEvent"),
        (l[(l.ResourceEvent = 2)] = "ResourceEvent"),
        (l[(l.ProgressionEvent = 3)] = "ProgressionEvent"),
        (l[(l.DesignEvent = 4)] = "DesignEvent"),
        (l[(l.ErrorEvent = 5)] = "ErrorEvent"),
        (l[(l.InitHttp = 9)] = "InitHttp"),
        (l[(l.EventsHttp = 10)] = "EventsHttp"),
        (l[(l.ProcessEvents = 11)] = "ProcessEvents"),
        (l[(l.AddEventsToStore = 12)] = "AddEventsToStore"),
        (l[(l.AdEvent = 20)] = "AdEvent"),
        ((v = u.EGASdkErrorAction || (u.EGASdkErrorAction = {}))[(v.Undefined = 0)] = "Undefined"),
        (v[(v.InvalidCurrency = 1)] = "InvalidCurrency"),
        (v[(v.InvalidShortString = 2)] = "InvalidShortString"),
        (v[(v.InvalidEventPartLength = 3)] = "InvalidEventPartLength"),
        (v[(v.InvalidEventPartCharacters = 4)] = "InvalidEventPartCharacters"),
        (v[(v.InvalidStore = 5)] = "InvalidStore"),
        (v[(v.InvalidFlowType = 6)] = "InvalidFlowType"),
        (v[(v.StringEmptyOrNull = 7)] = "StringEmptyOrNull"),
        (v[(v.NotFoundInAvailableCurrencies = 8)] = "NotFoundInAvailableCurrencies"),
        (v[(v.InvalidAmount = 9)] = "InvalidAmount"),
        (v[(v.NotFoundInAvailableItemTypes = 10)] = "NotFoundInAvailableItemTypes"),
        (v[(v.WrongProgressionOrder = 11)] = "WrongProgressionOrder"),
        (v[(v.InvalidEventIdLength = 12)] = "InvalidEventIdLength"),
        (v[(v.InvalidEventIdCharacters = 13)] = "InvalidEventIdCharacters"),
        (v[(v.InvalidProgressionStatus = 15)] = "InvalidProgressionStatus"),
        (v[(v.InvalidSeverity = 16)] = "InvalidSeverity"),
        (v[(v.InvalidLongString = 17)] = "InvalidLongString"),
        (v[(v.DatabaseTooLarge = 18)] = "DatabaseTooLarge"),
        (v[(v.DatabaseOpenOrCreate = 19)] = "DatabaseOpenOrCreate"),
        (v[(v.JsonError = 25)] = "JsonError"),
        (v[(v.FailHttpJsonDecode = 29)] = "FailHttpJsonDecode"),
        (v[(v.FailHttpJsonEncode = 30)] = "FailHttpJsonEncode"),
        (v[(v.InvalidAdAction = 31)] = "InvalidAdAction"),
        (v[(v.InvalidAdType = 32)] = "InvalidAdType"),
        (v[(v.InvalidString = 33)] = "InvalidString"),
        ((g = u.EGASdkErrorParameter || (u.EGASdkErrorParameter = {}))[(g.Undefined = 0)] = "Undefined"),
        (g[(g.Currency = 1)] = "Currency"),
        (g[(g.CartType = 2)] = "CartType"),
        (g[(g.ItemType = 3)] = "ItemType"),
        (g[(g.ItemId = 4)] = "ItemId"),
        (g[(g.Store = 5)] = "Store"),
        (g[(g.FlowType = 6)] = "FlowType"),
        (g[(g.Amount = 7)] = "Amount"),
        (g[(g.Progression01 = 8)] = "Progression01"),
        (g[(g.Progression02 = 9)] = "Progression02"),
        (g[(g.Progression03 = 10)] = "Progression03"),
        (g[(g.EventId = 11)] = "EventId"),
        (g[(g.ProgressionStatus = 12)] = "ProgressionStatus"),
        (g[(g.Severity = 13)] = "Severity"),
        (g[(g.Message = 14)] = "Message"),
        (g[(g.AdAction = 15)] = "AdAction"),
        (g[(g.AdType = 16)] = "AdType"),
        (g[(g.AdSdkName = 17)] = "AdSdkName"),
        (g[(g.AdPlacement = 18)] = "AdPlacement");
    })((gameanalytics = gameanalytics || {}));
  var gameanalytics,
    EGAErrorSeverity = gameanalytics.EGAErrorSeverity,
  ...
  !(function (e) {
    ...
    (function (e) {
      ...
      (n = e.utilities || (e.utilities = {})),
        (u = e.logging.GALogger),
        (c.getHmac = function (e, n) {
        ...
        (c.encode64 = function (e) {
          e = encodeURI(e);
          for (
            var n, t, i, r, s, a = "", o = 0, d = 0, u = 0;
            (i = (n = e.charCodeAt(u++)) >> 2),
              (r = ((3 & n) << 4) | ((t = e.charCodeAt(u++)) >> 4)),
              (s = ((15 & t) << 2) | ((o = e.charCodeAt(u++)) >> 6)),
              (d = 63 & o),
              isNaN(t) ? (s = d = 64) : isNaN(o) && (d = 64),
              (a = a + c.keyStr.charAt(i) + c.keyStr.charAt(r) + c.keyStr.charAt(s) + c.keyStr.charAt(d)),
              (n = t = o = 0),
              (i = r = s = d = 0),
              u < e.length;
        ...
        (c.decode64 = function (e) {
          var n,
            ...
            d = 0;
          for (
            /[^A-Za-z0-9\+\/\=]/g.exec(e) && u.w("There were invalid base64 characters in the input text. Valid base64 characters are A-Z, a-z, 0-9, '+', '/',and '='. Expect errors in decoding."), e = e.replace(/[^A-Za-z0-9\+\/\=]/g, "");
            (n = (c.keyStr.indexOf(e.charAt(d++)) << 2) | ((i = c.keyStr.indexOf(e.charAt(d++))) >> 4)),
              (t = ((15 & i) << 4) | ((r = c.keyStr.indexOf(e.charAt(d++))) >> 2)),
              (a = ((3 & r) << 6) | (o = c.keyStr.indexOf(e.charAt(d++)))),
              (s += String.fromCharCode(n)),
              64 != r && (s += String.fromCharCode(t)),
    ...
    (function (m) {
      !(function (e) {
        ...
        var n =
          ((f.validateBusinessEvent = function (e, n, t, i, r) {
            return f.validateCurrency(e)
              ? n < 0
                ? (d.w("Validation fail - business event - amount. Cannot be less than 0. Failed amount: " + n), new g(u.EventValidation, c.BusinessEvent, l.InvalidAmount, v.Amount, n + ""))
                : f.validateShortString(t, !0)
                ? f.validateEventPartLength(i, !1)
                  ? f.validateEventPartCharacters(i)
                    ? f.validateEventPartLength(r, !1)
                      ? f.validateEventPartCharacters(r)
                        ? null
                        : (d.w("Validation fail - business event - itemId: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + r), new g(u.EventValidation, c.BusinessEvent, l.InvalidEventPartCharacters, v.ItemId, r))
                      : (d.w("Validation fail - business event - itemId. Cannot be (null), empty or above 64 characters. String: " + r), new g(u.EventValidation, c.BusinessEvent, l.InvalidEventPartLength, v.ItemId, r))
                    : (d.w("Validation fail - business event - itemType: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + i), new g(u.EventValidation, c.BusinessEvent, l.InvalidEventPartCharacters, v.ItemType, i))
                  : (d.w("Validation fail - business event - itemType: Cannot be (null), empty or above 64 characters. String: " + i), new g(u.EventValidation, c.BusinessEvent, l.InvalidEventPartLength, v.ItemType, i))
                : (d.w("Validation fail - business event - cartType. Cannot be above 32 length. String: " + t), new g(u.EventValidation, c.BusinessEvent, l.InvalidShortString, v.CartType, t))
              : (d.w("Validation fail - business event - currency: Cannot be (null) and need to be A-Z, 3 characters and in the standard at openexchangerates.org. Failed currency: " + e), new g(u.EventValidation, c.BusinessEvent, l.InvalidCurrency, v.Currency, e));
          }),
          (f.validateResourceEvent = function (e, n, t, i, r, s, a) {
            return e == m.EGAResourceFlowType.Undefined
              ? (d.w("Validation fail - resource event - flowType: Invalid flow type."), new g(u.EventValidation, c.ResourceEvent, l.InvalidFlowType, v.FlowType, ""))
              : n
              ? o.stringArrayContainsString(s, n)
                ? 0 < t
                  ? i
                    ? f.validateEventPartLength(i, !1)
                      ? f.validateEventPartCharacters(i)
                        ? o.stringArrayContainsString(a, i)
                          ? f.validateEventPartLength(r, !1)
                            ? f.validateEventPartCharacters(r)
                              ? null
                              : (d.w("Validation fail - resource event - itemId: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + r), new g(u.EventValidation, c.ResourceEvent, l.InvalidEventPartCharacters, v.ItemId, r))
                            : (d.w("Validation fail - resource event - itemId: Cannot be (null), empty or above 64 characters. String: " + r), new g(u.EventValidation, c.ResourceEvent, l.InvalidEventPartLength, v.ItemId, r))
                          : (d.w("Validation fail - resource event - itemType: Not found in list of pre-defined available resource itemTypes. String: " + i), new g(u.EventValidation, c.ResourceEvent, l.NotFoundInAvailableItemTypes, v.ItemType, i))
                        : (d.w("Validation fail - resource event - itemType: Cannot contain other characters than A-z, 0-9, -_., ()!?. String: " + i), new g(u.EventValidation, c.ResourceEvent, l.InvalidEventPartCharacters, v.ItemType, i))
                      : (d.w("Validation fail - resource event - itemType: Cannot be (null), empty or above 64 characters. String: " + i), new g(u.EventValidation, c.ResourceEvent, l.InvalidEventPartLength, v.ItemType, i))
                    : (d.w("Validation fail - resource event - itemType: Cannot be (null)"), new g(u.EventValidation, c.ResourceEvent, l.StringEmptyOrNull, v.ItemType, ""))
                  : (d.w("Validation fail - resource event - amount: Float amount cannot be 0 or negative. Value: " + t), new g(u.EventValidation, c.ResourceEvent, l.InvalidAmount, v.Amount, t + ""))
                : (d.w("Validation fail - resource event - currency: Not found in list of pre-defined available resource currencies. String: " + n), new g(u.EventValidation, c.ResourceEvent, l.NotFoundInAvailableCurrencies, v.Currency, n))
              : (d.w("Validation fail - resource event - currency: Cannot be (null)"), new g(u.EventValidation, c.ResourceEvent, l.StringEmptyOrNull, v.Currency, ""));
          }),
          ...
          (f.validateDesignEvent = function (e) {
            return f.validateEventIdLength(e)
              ? f.validateEventIdCharacters(e)
                ? null
                : (d.w("Validation fail - design event - eventId: Non valid characters. Only allowed A-z, 0-9, -_., ()!?. String: " + e), new g(u.EventValidation, c.DesignEvent, l.InvalidEventIdCharacters, v.EventId, e))
              : (d.w("Validation fail - design event - eventId: Cannot be (null) or empty. Only 5 event parts allowed seperated by :. Each part need to be 32 characters or less. String: " + e), new g(u.EventValidation, c.DesignEvent, l.InvalidEventIdLength, v.EventId, e));
          }),
          (f.validateErrorEvent = function (e, n) {
            return e == m.EGAErrorSeverity.Undefined
              ? (d.w("Validation fail - error event - severity: Severity was unsupported value."), new g(u.EventValidation, c.ErrorEvent, l.InvalidSeverity, v.Severity, ""))
              : f.validateLongString(n, !0)
              ? null
              : (d.w("Validation fail - error event - message: Message cannot be above 8192 characters."), new g(u.EventValidation, c.ErrorEvent, l.InvalidLongString, v.Message, n));
          }),
          (f.validateAdEvent = function (e, n, t, i) {
            return e == m.EGAAdAction.Undefined
              ? (d.w("Validation fail - error event - severity: Severity was unsupported value."), new g(u.EventValidation, c.AdEvent, l.InvalidAdAction, v.AdAction, ""))
              : n == m.EGAAdType.Undefined
              ? (d.w("Validation fail - ad event - adType: Ad type was unsupported value."), new g(u.EventValidation, c.AdEvent, l.InvalidAdType, v.AdType, ""))
              : f.validateShortString(t, !1)
              ? f.validateString(i, !1)
                ? null
                : (d.w("Validation fail - ad event - message: Ad placement cannot be above 64 characters."), new g(u.EventValidation, c.AdEvent, l.InvalidString, v.AdPlacement, i))
              : (d.w("Validation fail - ad event - message: Ad SDK name cannot be above 32 characters."), new g(u.EventValidation, c.AdEvent, l.InvalidShortString, v.AdSdkName, t));
          }),
          (f.validateSdkErrorEvent = function (e, n, t, i, r) {
            return !(
              !f.validateKeys(e, n) ||
              (t === u.Undefined
                ? (d.w("Validation fail - sdk error event - type: Category was unsupported value."), 1)
                : i === c.Undefined
                ? (d.w("Validation fail - sdk error event - type: Area was unsupported value."), 1)
                : r === l.Undefined && (d.w("Validation fail - sdk error event - type: Action was unsupported value."), 1))
            );
          }),
    ...
    (function (e) {
      !(function (e) {
        ...
        var t =
          ...
          (r.sdkWrapperVersion = "javascript 4.1.2"),
          (r.osVersionPair = r.matchItem([navigator.platform, navigator.userAgent, navigator.appVersion, navigator.vendor].join(" "), [
            ...
            new n("kai_os", "KAIOS", "KAIOS"),
          ])),
          (r.buildPlatform = r.runtimePlatformToString()),
          (r.deviceModel = r.getDeviceModel()),
          (r.deviceManufacturer = r.getDeviceManufacturer()),
          (r.osVersion = r.getOSVersionString()),
          (r.browserVersion = r.getBrowserVersionString()),
          r);
        function r() {}
        e.GADevice = t;
      })(e.device || (e.device = {}));
    ...
    (function (e) {
      ...
      (n = e.threading || (e.threading = {})),
        (i.prototype.enqueue = function (e, n) {
    ...
    (function (a) {
      !(function (e) {
        var l,
          ...
          t,
          i,
          r = a.logging.GALogger;
        ((n = l = e.EGAStoreArgsOperator || (e.EGAStoreArgsOperator = {}))[(n.Equal = 0)] = "Equal"),
          (n[(n.LessOrEqual = 1)] = "LessOrEqual"),
          (n[(n.NotEqual = 2)] = "NotEqual"),
          ((i = t = e.EGAStore || (e.EGAStore = {}))[(i.Events = 0)] = "Events"),
          (i[(i.Sessions = 1)] = "Sessions"),
          (i[(i.Progression = 2)] = "Progression");
        var s =
          ((v.isStorageAvailable = function () {
          ...
          (v.select = function (e, n, t, i) {
            ...
            return (
              ...
              0 < i && s.length > i && (s = s.slice(0, i + 1)),
              s
            );
          }),
          ...
          (v.save = function (e) {
            v.isStorageAvailable()
              ? (localStorage.setItem(v.StringFormat(v.KeyFormat, e, v.EventsStoreKey), JSON.stringify(v.instance.eventsStore)),
                localStorage.setItem(v.StringFormat(v.KeyFormat, e, v.SessionsStoreKey), JSON.stringify(v.instance.sessionsStore)),
                localStorage.setItem(v.StringFormat(v.KeyFormat, e, v.ProgressionStoreKey), JSON.stringify(v.instance.progressionStore)),
                localStorage.setItem(v.StringFormat(v.KeyFormat, e, v.ItemsStoreKey), JSON.stringify(v.instance.storeItems)))
              : r.w("Storage is not available, cannot save.");
          }),
          (v.load = function (e) {
          ...
          (v.instance = new v()),
          (v.MaxNumberOfEntries = 2e3),
          (v.StringFormat = function (e) {
          ...
          (v.KeyFormat = "GA::{0}::{1}"),
          (v.EventsStoreKey = "ga_event"),
          (v.SessionsStoreKey = "ga_session"),
          (v.ProgressionStoreKey = "ga_progression"),
          (v.ItemsStoreKey = "ga_items"),
          v);
        function v() {
    ...
    (function (e) {
      ...
      (n = e.state || (e.state = {})),
        (r = e.validators.GAValidator),
        (d = e.utilities.GAUtilities),
        (u = e.logging.GALogger),
        (o = e.store.GAStore),
        (s = e.device.GADevice),
        (c = e.store.EGAStore),
        (t = e.store.EGAStoreArgsOperator),
        ...
        (l.getEventAnnotations = function () {
          ...
          (e.user_id = l.instance.identifier),
            ...
            (e.sdk_version = s.getRelevantSdkVersion()),
            (e.os_version = s.osVersion),
            (e.manufacturer = s.deviceManufacturer),
            (e.device = s.deviceModel),
            (e.browser_version = s.browserVersion),
            (e.platform = s.buildPlatform),
        ...
        (l.ensurePersistedStates = function () {
          ...
          var e = l.instance;
          e.setDefaultId(null != o.getItem(l.getGameKey(), l.DefaultUserIdKey) ? o.getItem(l.getGameKey(), l.DefaultUserIdKey) : d.createGuid()),
            (e.sessionNum = null != o.getItem(l.getGameKey(), l.SessionNumKey) ? Number(o.getItem(l.getGameKey(), l.SessionNumKey)) : 0),
            (e.transactionNum = null != o.getItem(l.getGameKey(), l.TransactionNumKey) ? Number(o.getItem(l.getGameKey(), l.TransactionNumKey)) : 0),
            e.currentCustomDimension01 ? o.setItem(l.getGameKey(), l.Dimension01Key, e.currentCustomDimension01) : ((e.currentCustomDimension01 = null != o.getItem(l.getGameKey(), l.Dimension01Key) ? o.getItem(l.getGameKey(), l.Dimension01Key) : ""), e.currentCustomDimension01),
            e.currentCustomDimension02 ? o.setItem(l.getGameKey(), l.Dimension02Key, e.currentCustomDimension02) : ((e.currentCustomDimension02 = null != o.getItem(l.getGameKey(), l.Dimension02Key) ? o.getItem(l.getGameKey(), l.Dimension02Key) : ""), e.currentCustomDimension02),
            e.currentCustomDimension03 ? o.setItem(l.getGameKey(), l.Dimension03Key, e.currentCustomDimension03) : ((e.currentCustomDimension03 = null != o.getItem(l.getGameKey(), l.Dimension03Key) ? o.getItem(l.getGameKey(), l.Dimension03Key) : ""), e.currentCustomDimension03);
                ...
                if (t < l.MAX_CUSTOM_FIELDS_COUNT) {
                  ...
                  if (d.stringMatch(i, s)) {
                    ...
                    if ("string" == a || r instanceof String)
                      r.length <= l.MAX_CUSTOM_FIELDS_VALUE_STRING_LENGTH && 0 < r.length
                        ? ((n[i] = r), ++t)
                        : u.w("validateAndCleanCustomFields: entry with key=" + i + ", value=" + r + " has been omitted because its value is an empty string or exceeds the max number of characters (" + l.MAX_CUSTOM_FIELDS_VALUE_STRING_LENGTH + ")");
        ...
        (l.validateAndFixCurrentDimensions = function () {
          r.validateDimension01(l.getCurrentCustomDimension01(), l.getAvailableCustomDimensions01()) || l.setCustomDimension01(""),
            r.validateDimension02(l.getCurrentCustomDimension02(), l.getAvailableCustomDimensions02()) || l.setCustomDimension02(""),
            r.validateDimension03(l.getCurrentCustomDimension03(), l.getAvailableCustomDimensions03()) || l.setCustomDimension03("");
        }),
        ...
        (l.removeRemoteConfigsListener = function (e) {
          var n = l.instance.remoteConfigsListeners.indexOf(e);
          -1 < n && l.instance.remoteConfigsListeners.splice(n, 1);
        }),
    ...
    (function (e) {
      ...
      (n = e.tasks || (e.tasks = {})),
        ...
        (d = e.logging.GALogger),
        (u.execute = function (e, n, t, i) {
          var r = new Date();
    ...
    (function (e) {
      ...
      (c = e.http || (e.http = {})),
        (p = e.state.GAState),
        (S = e.logging.GALogger),
        (l = e.utilities.GAUtilities),
        (A = e.validators.GAValidator),
        (h = e.tasks.SdkErrorTask),
        (v = e.events.EGASdkErrorCategory),
        (g = e.events.EGASdkErrorArea),
        (f = e.events.EGASdkErrorAction),
        (m = e.events.EGASdkErrorParameter),
        (y.prototype.requestInit = function (e, n) {
          var t = p.getGameKey(),
        ...
        (y.prototype.sendSdkErrorEvent = function (e, n, t, i, r, s, a) {
          if (p.isEventSubmissionEnabled() && A.validateSdkErrorEvent(s, a, e, n, t)) {
            var o,
              d = this.baseUrl + "/" + s + "/" + this.eventsUrlPath,
              u = "",
        ...
        (y.prototype.processRequestResponse = function (e, n, t, i) {
          return t
            ? 200 === e
              ? c.EGAHTTPApiResponse.Ok
              : 201 === e
              ? c.EGAHTTPApiResponse.Created
              : 0 === e || 401 === e
              ? c.EGAHTTPApiResponse.Unauthorized
              : 400 === e
              ? c.EGAHTTPApiResponse.BadRequest
              : 500 === e
              ? c.EGAHTTPApiResponse.InternalServerError
              : c.EGAHTTPApiResponse.UnknownResponseCode
            : c.EGAHTTPApiResponse.NoResponse;
        }),
        ...
        (y.instance = new y()),
        (y.MAX_ERROR_MESSAGE_LENGTH = 256),
        (n = y),
        (c.GAHTTPApi = n);
    })((gameanalytics = gameanalytics || {})),
    (function (g) {
      ...
      (v = g.events || (g.events = {})),
        (f = g.store.GAStore),
        (m = g.store.EGAStore),
        (E = g.store.EGAStoreArgsOperator),
        (p = g.state.GAState),
        (S = g.logging.GALogger),
        (A = g.utilities.GAUtilities),
        (u = g.http.EGAHTTPApiResponse),
        (h = g.http.GAHTTPApi),
        (y = g.validators.GAValidator),
        ...
        (C.addBusinessEvent = function (e, n, t, i, r, s) {
          if ((void 0 === r && (r = null), p.isEventSubmissionEnabled())) {
            ...
            if (null == a) {
              var o = {};
              p.incrementTransactionNum(),
                f.setItem(p.getGameKey(), p.TransactionNumKey, p.getTransactionNum().toString()),
                (o.event_id = t + ":" + i),
                (o.category = C.CategoryBusiness),
                (o.currency = e),
                (o.amount = n),
                (o[p.TransactionNumKey] = p.getTransactionNum()),
                r && (o.cart_type = r),
                C.addDimensionsToEvent(o),
                C.addFieldsToEvent(o, p.validateAndCleanCustomFields(s)),
                S.i("Add BUSINESS event: {currency:" + e + ", amount:" + n + ", itemType:" + t + ", itemId:" + i + ", cartType:" + r + "}"),
                C.addEventToStore(o);
        ...
        (C.addResourceEvent = function (e, n, t, i, r, s) {
          if (p.isEventSubmissionEnabled()) {
            ...
            if (null == a) {
              ...
              (o.event_id = d + ":" + n + ":" + i + ":" + r),
                (o.category = C.CategoryResource),
                (o.amount = t),
                C.addDimensionsToEvent(o),
                C.addFieldsToEvent(o, p.validateAndCleanCustomFields(s)),
                S.i("Add RESOURCE event: {currency:" + n + ", amount:" + t + ", itemType:" + i + ", itemId:" + r + "}"),
                C.addEventToStore(o);
            } else h.instance.sendSdkErrorEvent(a.category, a.area, a.action, a.parameter, a.reason, p.getGameKey(), p.getGameSecret());
          }
        }),
        (C.addProgressionEvent = function (e, n, t, i, r, s, a) {
          if (p.isEventSubmissionEnabled()) {
            ...
            if (null == d) {
              ...
              var l = 0;
              s && e != g.EGAProgressionStatus.Start && (c.score = r),
                e === g.EGAProgressionStatus.Fail && p.incrementProgressionTries(u),
                e === g.EGAProgressionStatus.Complete && (p.incrementProgressionTries(u), (l = p.getProgressionTries(u)), (c.attempt_num = l), p.clearProgressionTries(u)),
                C.addDimensionsToEvent(c),
                C.addFieldsToEvent(c, p.validateAndCleanCustomFields(a)),
                S.i("Add PROGRESSION event: {status:" + o + ", progression01:" + n + ", progression02:" + t + ", progression03:" + i + ", score:" + r + ", attempt:" + l + "}"),
                C.addEventToStore(c);
        ...
        (C.addAdEvent = function (e, n, t, i, r, s, a, o) {
          if (p.isEventSubmissionEnabled()) {
            ...
            if (null == l) {
              var v = {};
              (v.category = C.CategoryAds),
                (v.ad_sdk_name = t),
                (v.ad_placement = i),
                (v.ad_type = u),
                (v.ad_action = d),
                e == g.EGAAdAction.FailedShow && 0 < c.length && (v.ad_fail_show_reason = c),
                !a || (n != g.EGAAdType.RewardedVideo && n != g.EGAAdType.Video) || (v.ad_duration = s),
                C.addDimensionsToEvent(v),
                C.addFieldsToEvent(v, p.validateAndCleanCustomFields(o)),
                S.i(
                  "Add AD event: {ad_sdk_name:" +
                    ...
                    ", ad_action:" +
                    d +
                    (e == g.EGAAdAction.FailedShow && 0 < c.length ? ", ad_fail_show_reason:" + c : "") +
                    (!a || (n != g.EGAAdType.RewardedVideo && n != g.EGAAdType.Video) ? "" : ", ad_duration:" + s) +
                    "}"
                ),
                C.addEventToStore(v);
        ...
        (C.addEventToStore = function (e) {
          if (p.isEventSubmissionEnabled())
            if (p.isInitialized())
              try {
                if (f.isStoreTooLargeForEvents() && !A.stringMatch(e.category, /^(user|session_end|business)$/))
                  return S.w("Database too large. Event has been blocked."), void h.instance.sendSdkErrorEvent(v.EGASdkErrorCategory.Database, v.EGASdkErrorArea.AddEventsToStore, v.EGASdkErrorAction.DatabaseTooLarge, v.EGASdkErrorParameter.Undefined, "", p.getGameKey(), p.getGameSecret());
                ...
                (s.category = n.category),
                  ...
                  (s.client_ts = n.client_ts),
                  (s.event = A.encode64(JSON.stringify(n))),
                  f.insert(m.Events, s),
                  e.category == C.CategorySessionEnd ? f.delete(m.Sessions, [["session_id", E.Equal, n.session_id]]) : (((s = {}).session_id = n.session_id), (s.timestamp = p.getSessionStart()), (s.event = t), f.insert(m.Sessions, s, !0, "session_id")),
                  f.isStorageAvailable() && f.save(p.getGameKey());
              } catch (i) {
        ...
        (C.progressionStatusToString = function (e) {
          return e == g.EGAProgressionStatus.Start || e == g.EGAProgressionStatus[g.EGAProgressionStatus.Start]
            ? "Start"
            : e == g.EGAProgressionStatus.Complete || e == g.EGAProgressionStatus[g.EGAProgressionStatus.Complete]
            ? "Complete"
            : e == g.EGAProgressionStatus.Fail || e == g.EGAProgressionStatus[g.EGAProgressionStatus.Fail]
            ? "Fail"
            : "";
        }),
        (C.errorSeverityToString = function (e) {
          return e == g.EGAErrorSeverity.Debug || e == g.EGAErrorSeverity[g.EGAErrorSeverity.Debug]
            ? "debug"
            : e == g.EGAErrorSeverity.Info || e == g.EGAErrorSeverity[g.EGAErrorSeverity.Info]
            ? "info"
            : e == g.EGAErrorSeverity.Warning || e == g.EGAErrorSeverity[g.EGAErrorSeverity.Warning]
            ? "warning"
            : e == g.EGAErrorSeverity.Error || e == g.EGAErrorSeverity[g.EGAErrorSeverity.Error]
            ? "error"
            : e == g.EGAErrorSeverity.Critical || e == g.EGAErrorSeverity[g.EGAErrorSeverity.Critical]
            ? "critical"
            : "";
        }),
        (C.adActionToString = function (e) {
          return e == g.EGAAdAction.Clicked || e == g.EGAAdAction[g.EGAAdAction.Clicked]
            ? "clicked"
            : e == g.EGAAdAction.Show || e == g.EGAAdAction[g.EGAAdAction.Show]
            ? "show"
            : e == g.EGAAdAction.FailedShow || e == g.EGAAdAction[g.EGAAdAction.FailedShow]
            ? "failed_show"
            : e == g.EGAAdAction.RewardReceived || e == g.EGAAdAction[g.EGAAdAction.RewardReceived]
            ? "reward_recevied"
            : "";
        }),
        (C.adErrorToString = function (e) {
          return e == g.EGAAdError.Unknown || e == g.EGAAdError[g.EGAAdError.Unknown]
            ? "unknown"
            : e == g.EGAAdError.Offline || e == g.EGAAdError[g.EGAAdError.Offline]
            ? "offline"
            : e == g.EGAAdError.NoFill || e == g.EGAAdError[g.EGAAdError.NoFill]
            ? "no_fill"
            : e == g.EGAAdError.InternalError || e == g.EGAAdError[g.EGAAdError.InternalError]
            ? "internal_error"
            : e == g.EGAAdError.InvalidRequest || e == g.EGAAdError[g.EGAAdError.InvalidRequest]
            ? "invalid_request"
            : e == g.EGAAdError.UnableToPrecache || e == g.EGAAdError[g.EGAAdError.UnableToPrecache]
            ? "unable_to_precache"
            : "";
        }),
        (C.adTypeToString = function (e) {
          return e == g.EGAAdType.Video || e == g.EGAAdType[g.EGAAdType.Video]
            ? "video"
            : e == g.EGAAdType.RewardedVideo || e == g.EGAAdError[g.EGAAdType.RewardedVideo]
            ? "rewarded_video"
            : e == g.EGAAdType.Playable || e == g.EGAAdError[g.EGAAdType.Playable]
            ? "playable"
            : e == g.EGAAdType.Interstitial || e == g.EGAAdError[g.EGAAdType.Interstitial]
            ? "interstitial"
            : e == g.EGAAdType.OfferWall || e == g.EGAAdError[g.EGAAdType.OfferWall]
            ? "offer_wall"
            : e == g.EGAAdType.Banner || e == g.EGAAdError[g.EGAAdType.Banner]
            ? "banner"
            : "";
        }),
    ...
    (function (e) {
      ...
      (r = e.threading || (e.threading = {})),
        (n = e.logging.GALogger),
        (t = e.state.GAState),
        (i = e.events.GAEvents),
        (a.createTimedBlock = function (e) {
          void 0 === e && (e = 0);
          var n = new Date();
        ...
        (a.instance = new a()),
        (a.ThreadWaitTimeInMs = 1e3),
        (a.ProcessEventsIntervalInSeconds = 8),
        (s = a),
        (r.GAThreading = s);
    })((gameanalytics = gameanalytics || {})),
    (function (a) {
      var o = a.threading.GAThreading,
        ...
        n =
          ((m.init = function () {
            if (
              (l.touch(),
              (m.methodMap.configureAvailableCustomDimensions01 = m.configureAvailableCustomDimensions01),
              ...
              (m.methodMap.configureBuild = m.configureBuild),
              (m.methodMap.configureSdkGameEngineVersion = m.configureSdkGameEngineVersion),
              (m.methodMap.configureGameEngineVersion = m.configureGameEngineVersion),
              (m.methodMap.configureUserId = m.configureUserId),
              (m.methodMap.initialize = m.initialize),
              (m.methodMap.addBusinessEvent = m.addBusinessEvent),
              (m.methodMap.addResourceEvent = m.addResourceEvent),
              (m.methodMap.addProgressionEvent = m.addProgressionEvent),
              (m.methodMap.addDesignEvent = m.addDesignEvent),
              (m.methodMap.addErrorEvent = m.addErrorEvent),
              (m.methodMap.addErrorEvent = m.addErrorEvent),
              (m.methodMap.setEnabledInfoLog = m.setEnabledInfoLog),
              (m.methodMap.setEnabledVerboseLog = m.setEnabledVerboseLog),
              (m.methodMap.setEnabledManualSessionHandling = m.setEnabledManualSessionHandling),
              (m.methodMap.setEnabledEventSubmission = m.setEnabledEventSubmission),
              (m.methodMap.setCustomDimension01 = m.setCustomDimension01),
              (m.methodMap.setCustomDimension02 = m.setCustomDimension02),
              (m.methodMap.setCustomDimension03 = m.setCustomDimension03),
              (m.methodMap.setEventProcessInterval = m.setEventProcessInterval),
              (m.methodMap.startSession = m.startSession),
              (m.methodMap.endSession = m.endSession),
              (m.methodMap.onStop = m.onStop),
              (m.methodMap.onResume = m.onResume),
              (m.methodMap.addRemoteConfigsListener = m.addRemoteConfigsListener),
              (m.methodMap.removeRemoteConfigsListener = m.removeRemoteConfigsListener),
              (m.methodMap.getRemoteConfigsValueAsString = m.getRemoteConfigsValueAsString),
              (m.methodMap.isRemoteConfigsReady = m.isRemoteConfigsReady),
          ...
          (m.initialize = function (e, n) {
            ...
            (t.async = !0),
              (m.initTimedBlockId = t.id),
              (t.block = function () {
                m.isSdkReady(!0, !1)
                  ? d.w("SDK already initialized. Can only be called once.")
                  : i.validateKeys(e, n)
                  ? (c.setKeys(e, n), m.internalInitialize())
                  : d.w("SDK failed initialize. Game key or secret key is invalid. Can only contain characters A-z 0-9, gameKey is 32 length, gameSecret is 40 length. Failed keys - gameKey: " + e + ", secretKey: " + n);
              }),
          ...
          (m.addProgressionEvent = function (n, t, i, r, s) {
            void 0 === n && (n = a.EGAProgressionStatus.Undefined),
              void 0 === t && (t = ""),
              void 0 === i && (i = ""),
              void 0 === r && (r = ""),
              l.updateConnectionType(),
          ...
          (m.addErrorEvent = function (e, n) {
            void 0 === e && (e = a.EGAErrorSeverity.Undefined),
              void 0 === n && (n = ""),
              l.updateConnectionType(),
              o.performTaskOnGAThread(function () {
          ...
          (m.addAdEventWithNoAdReason = function (e, n, t, i, r) {
            void 0 === e && (e = a.EGAAdAction.Undefined),
              void 0 === n && (n = a.EGAAdType.Undefined),
              void 0 === t && (t = ""),
              void 0 === i && (i = ""),
              void 0 === r && (r = a.EGAAdError.Undefined),
              l.updateConnectionType(),
              o.performTaskOnGAThread(function () {
          ...
          (m.startNewSessionCallback = function (e, n) {
            if ((e !== v.Ok && e !== v.Created) || !n)
              e == v.Unauthorized
                ? (d.w("Initialize SDK failed - Unauthorized"), (c.instance.initAuthorized = !1))
                : (e === v.NoResponse || e === v.RequestTimeout
                    ? d.i("Init call (session start) failed - no response. Could be offline or timeout.")
                    : e === v.BadResponse || e === v.JsonEncodeFailed || e === v.JsonDecodeFailed
                    ? d.i("Init call (session start) failed - bad response. Could be bad response from proxy or GA servers.")
                    : (e !== v.BadRequest && e !== v.UnknownResponseCode) || d.i("Init call (session start) failed - bad request or unknown response."),
                  null == c.instance.sdkConfig
                    ? null != c.instance.sdkConfigCached
                      ? (d.i("Init call (session start) failed - using cached init values."), (c.instance.sdkConfig = c.instance.sdkConfigCached))
                      : (d.i("Init call (session start) failed - using default init values."), (c.instance.sdkConfig = c.instance.sdkConfigDefault))
                    : d.i("Init call (session start) failed - using cached init values."),
                  (c.instance.initAuthorized = !0));
            else {
              var t = 0;
              if (n.server_ts) {
                var i = n.server_ts;
              ...
              (c.instance.configsHash = n.configs_hash ? n.configs_hash : ""),
                (c.instance.abId = n.ab_id ? n.ab_id : ""),
                (c.instance.abVariantId = n.ab_variant_id ? n.ab_variant_id : ""),
                u.setItem(c.getGameKey(), c.SdkConfigCachedKey, g.encode64(JSON.stringify(n))),
                (c.instance.sdkConfigCached = n),
                (c.instance.sdkConfig = n),
                (c.instance.initAuthorized = !0);
            }
          ...
          (m.isSdkReady = function (e, n, t) {
            return (
              void 0 === n && (n = !0), void 0 === t && (t = ""), t && (t += ": "), e && !c.isInitialized() ? (n && d.w(t + "SDK is not initialized"), !1) : e && !c.isEnabled() ? (n && d.w(t + "SDK is disabled"), !1) : !(e && !c.sessionIsStarted() && (n && d.w(t + "Session has not started yet"), 1))
            );
          }),
          (m.initTimedBlockId = -1),
          (m.methodMap = {}),
          m);
      function m() {}
      a.GameAnalytics = n;
