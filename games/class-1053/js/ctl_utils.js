...
function sizeHandler() {
	...
	var destH = CANVAS_HEIGHT * multiplier;
        ...
        if(s_oSelectCharacter !== null){
            s_oSelectCharacter.refreshButtonPos( s_iOffsetX,s_iOffsetY);
        }    
        ...
        if(s_oCreditsPanel !== null){
			s_oCreditsPanel.refreshButtonPos( s_iOffsetX,s_iOffsetY);
		}
        
        
	$("#canvas").css("width",destW+"px");
	$("#canvas").css("height",destH+"px");
        $("#canvasbg").css("width",destW+"px");
	$("#canvasbg").css("height",destH+"px");
	$("#canvas_interface").css("width",destW+"px");
	$("#canvas_interface").css("height",destH+"px");
        
        if(fOffsetY < 0){
            $("#canvas").css("top",fOffsetY+"px");
            $("#canvasbg").css("top",fOffsetY+"px");
            $("#canvas_interface").css("top",fOffsetY+"px");
        }else{
            $("#canvas").css("top","0px");
            $("#canvasbg").css("top","0px");
            $("#canvas_interface").css("top","0px");
        }
        
        $("#canvas").css("left",fOffsetX+"px");
        $("#canvasbg").css("left",fOffsetX+"px");
        $("#canvas_interface").css("left",fOffsetX+"px");

        s_oMultiplier=multiplier;
};
