class ScenePlayoffBracket extends Phaser.Scene {
  ...
  create() {
      ...
      if(playoffConference == "NFC"){
        ...
        this.visitorTeam = this.add.image(790,42,'helmetLions');
      }
      ...
      */
      ...
      this.buttonJaguars = this.add.sprite(63, 271, 'helmetJaguars');
      this.buttonJaguars.setScale(-1,1);

      //2022...
      /*this.buttonRavens = this.add.sprite(63, 444, 'helmetRavens');
      this.buttonRavens.setScale(-1,1);*/
      this.buttonChargers = this.add.sprite(63, 444, 'helmetChargers');
      this.buttonChargers.setScale(-1,1);
      ...
      //NFC
      //this.buttonNiners = this.add.sprite(790, 100, 'helmetNiners');
      //if player chooses Niners
      if(player1Key == "keyNiners"){
        this.buttonNiners = this.add.sprite(790, 100, 'helmetCardinals');
      }else{
        this.buttonNiners = this.add.sprite(790, 100, 'helmetNiners');
      }
      ...
      this.buttonGiants = this.add.sprite(790, 157, 'helmetGiants');  

      this.buttonSeahawks = this.add.sprite(790, 271, 'helmetSeahawks');

      this.buttonEagles = this.add.sprite(790, 331, 'helmetEagles');

      this.buttonVikings = this.add.sprite(790, 215, 'helmetVikings');
...
//Rounds helmets...
      ...
      if(playoffRound >= 2){
        ...
        if(playoffConference == "NFC"){
          ...
          this.buttonNFC2a = this.add.sprite(695, 92, 'helmetNiners');
        } 
        if(player1Key != "keyEagles"){
          this.buttonNFC2b = this.add.sprite(695, 167, 'helmetEagles');
        }else{
          this.buttonNFC2b = this.add.sprite(695, 167, 'helmetSeahawks');
        }
        this.buttonNFC2c = this.add.sprite(695, 318, 'helmetGiants');
        ...
        if(playoffConference == "AFC"){
          ...
          if(playoffRound == 3){
            ...
            if(player1Key == "keyBills"){
              ...
              this.buttonAFC3b = this.add.sprite(257, 280, 'helmetChargers');
              this.buttonAFC3b.setScale(-1,1);
            }
          }
        }else{
        ...
        if(playoffConference == "NFC"){
          ...
          if(playoffRound == 3){
            ...
            if(player1Key == "keyBuccaneers"){
              ...
              this.buttonNFC3b = this.add.sprite(600, 280, 'helmetGiants');
            }
          }
        }else{
          this.buttonNFC2a = this.add.sprite(600, 205, 'helmetNiners');
        } 
      }
      if(playoffRound == 4){
        //afc
        ...
        if(playoffConference == "NFC"){
          ...
          this.buttonNFC2a = this.add.sprite(500, 252, 'helmetEagles');
        } 
...
*/
      ...
      this.btnPlay.setOrigin(0,0);
        ...
        this.btnPlay.on("pointerup", function() {
          ...
          //playerGraphics = ['content/playerNiners.png','content/playerRaiders.png'];
      ...
      this.btnSelect2.setOrigin(0,0);
        ...
        this.btnSelect2.on("pointerup", function() {
          ...
          playerGraphics = ['content/playerRaiders.png', 'content/playerNiners.png'];
          this.scene.start("SceneTimeMenu");
        }, this);
        */
