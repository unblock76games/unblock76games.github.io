...
function distance( oPos1, oPos2){
    return Math.sqrt( ( (oPos2.x - oPos1.x)*(oPos2.x - oPos1.x) ) + ( (oPos2.y - oPos1.y)*(oPos2.y - oPos1.y) ) );
}	

function distanceWithoutSQRT( oPos1, oPos2){
    return ( (oPos2.x-oPos1.x) * (oPos2.x-oPos1.x) ) + ( (oPos2.y-oPos1.y) * (oPos2.y-oPos1.y) );
}
