function CAreYouSurePanel(oParentContainer){
    ...
    this._init = function(){
        ...
        _oButYes = new CGfxButton(CANVAS_WIDTH/2 + 175,800,s_oSpriteLibrary.getSprite("but_yes"),_oContainer);
        _oButYes.addEventListener(ON_MOUSE_UP,this._onReleaseYes,this);
        
        _oButNo = new CGfxButton(CANVAS_WIDTH/2 - 175,800,s_oSpriteLibrary.getSprite("but_no"),_oContainer);
