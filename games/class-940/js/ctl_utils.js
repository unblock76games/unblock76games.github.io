...
function sizeHandler() {
    ...
    if(s_oSpinnerPanel !== null){
        s_oSpinnerPanel.refreshButtonPos();
    }
...
function soundIsPlaying(szSound){
    if(DISABLE_SOUND_MOBILE === false || s_bMobile === false){
