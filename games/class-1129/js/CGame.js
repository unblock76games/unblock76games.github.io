function CGame(oInfo){
    ...
    this.shiftRight = function(){
        if(_iState === STATE_MOVE){
            ...
            if(_oFallingBlock.getX() < GRID_OFFSET_X +((GRID_COLS-1) * GRID_SIZE) && (_aTable[iBlockRow][jBlockRow+1] === BLOCK_EMPTY )){
                    _oFallingBlock.setX(_oFallingBlock.getX() + GRID_SIZE);
            }
        }
    };
    ...
    var oSpriteCell = s_oSpriteLibrary.getSprite('block');
    GRID_SIZE = oSpriteCell.width/NUM_COLORS;
