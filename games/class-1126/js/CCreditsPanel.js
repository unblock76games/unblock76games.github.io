function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        var oTitle = new createjs.Text(TEXT_DEVELOPED," 40px "+FONT, "#ffb557");
        oTitle.y = -40;
        oTitle.textAlign = "center";
        oTitle.textBaseline = "alphabetic";
        _oPanelContainer.addChild(oTitle);

        var oLink = new createjs.Text("www.codethislab.com"," 40px "+FONT, "#ffb557");
        oLink.y = 140;
        ...
        _oButExit = new CGfxButton(250, -128, oSprite, _oPanelContainer);
