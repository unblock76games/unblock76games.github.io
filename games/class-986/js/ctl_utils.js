...
function sizeHandler() {
    ...
    if(s_oCongratulations!==null){
        s_oCongratulations.refreshButtonPos(s_iOffsetX,s_iOffsetY);
    }
...
function distanceWithoutSQRT(oVec1, oVec2){
    var iDx = oVec1.x - oVec2.x;
    var iDy = oVec1.y - oVec2.y;
    
  // console.log(oVec2.x);
    
    var fdistance = (iDx * iDx) + (iDy * iDy);
